  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position:'absolute', top:'-100px', left:'-100px', width:'350px', height:'350px',
          borderRadius:'50%', background:'rgba(100,181,246,0.06)', pointerEvents:'none' }} />
        <div style={{ position:'absolute', bottom:'-80px', right:'30%', width:'260px', height:'260px',
          borderRadius:'50%', background:'rgba(229,57,53,0.08)', pointerEvents:'none' }} />
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'16px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize:'12px', color:'rgba(255,255,255,0.55)', marginTop:'4px', letterSpacing:'0.5px' }}>
              Magen David Adom
            </div>
          </div>
        </div>
        ...
        {/* Feature grid — hide on mobile to keep it clean */}
        {!isMobile && (
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign:'center', marginBottom:'32px' }}>
            ...
            <h2 style={{ fontSize:'22px', fontWeight:'800', color:'#1a1a2e', margin:'0 0 6px' }}>
              התחברות למערכת
            </h2>
          ...
          <form onSubmit={handleLogin} noValidate style={{ display:'flex', flexDirection:'column', gap:'18px' }}>
            ...
            <button
              ...
              style={{
                width:'100%',
                padding:'14px',
                background: (isLoading || !userId || !password)
                  ? '#cfd8dc'
                  : 'linear-gradient(135deg, #1565c0 0%, #CC0000 100%)',
                color:'white',
                border:'none',
                borderRadius:'12px',
                fontSize:'16px',
                ...
                display:'flex', alignItems:'center', justifyContent:'center',
                gap:'8px',
                boxShadow:(isLoading || !userId || !password)
                  ? 'none'
          ...
          <div style={{
            ...
            <p style={{ fontSize:'12px', color:'#90a4ae', textAlign:'center', margin:'0 0 10px', fontWeight:'600' }}>
              🎮 כניסה מהירה — מצב דמו
            </p>
          ...
          <div style={{ textAlign:'center', marginTop:'20px' }}>
            <a
              href="/help"
              style={{ color:'#78909c', textDecoration:'none', fontSize:'13px' }}
...
function LoginField({ label, type, value, onChange, placeholder, autoFocus }) {
    ...
    <div>
      ...
      <input
        ...
        style={{
          width:'100%',
          padding:'12px 16px',
          border: focused ? '2px solid #CC0000' : '2px solid #e8ecf0',
          borderRadius:'12px',
          fontSize:'15px',
          outline:'none',
          direction:'rtl',
